...
<div class="form-group">
		<h4>會員編號:</h4>
		<input type="TEXT" name="memno"  placeholder="輸入會員編號"  class="email-bt" required
...
<div class="form-group">
	    <h4>一般商城訂單編號:</h4>
		<input type="TEXT" name="orderno"  placeholder="輸入一般商城訂單編號" class="email-bt" required
			 value="<%= (repairformVO==null)? "" : repairformVO.getOrderno()%>" />
</div>
<!-- ==================================================4.商品編號-->	
<div class="form-group">
	    <h4>商品編號:</h4>
		<input type="TEXT" name="itemno"  placeholder="輸入商品編號" class="email-bt" required
...
<div class="form-group">
	    <h4>維修狀態:</h4>
		   <input type="TEXT" name="repairformstatus" class="email-bt" required
            value="<%= (repairformVO==null)? "維修狀態會由專人填寫" : repairformVO.getRepairformstatus()%>" />
</div>
<!-- ===================================================7.確認維修單員工編號-->	
	<div class="form-group">
	    <h4>維修員工編號(預設為0):</h4>
		   <input type="TEXT" name="adminno" placeholder="維修員工編號會由專人填寫" class="email-bt" required
           value="<%= (repairformVO==null)? "0" : repairformVO.getAdminno()%>" />
	</div>
<!-- =====================================================8.修理備註-->	
	<div class="form-group">
	    <h4>修理備註:</h4>
        <textarea type="TEXT" name="repairinfo" placeholder=" 修理備註 Massage" rows="5"  required
           id="comment"  class="massage-bt" 
            required value="<%= (repairformVO==null)? "" : repairformVO.getRepairinfo()%>">
        </textarea>
	</div>
...
<input type="submit" class="button" value="送出新增" >
</body>	
