			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="first-slide" src="images/1.jpg"
						style="width: 100%; height: 650px;" alt="First slide">
					<div class="container">
				...
				<div class="carousel-item">
					<img class="second-slide" src="images/2.jpg"
						style="width: 100%; height: 650px;" alt="Second slide">
					<div class="container">
						<div class="carousel-caption relative">
							<span>看見新視界</span>
							<h1>GALAXY S7</h1>
				...
				<div class="carousel-item">
					<img class="third-slide" src="images/33.png"
						style="width: 100%; height: 650px;" alt="Third slide">
					<div class="container">
						<div class="carousel-caption relative">
							<span>繽紛你的生活</span>
							<h1>CANDY PHONE</h1>
